...
contract RaffleTest is Test {
    ...
    // testCheckUpkeepReturnsFalseIfEnoughtTimeHasntPassed
    ...
    // What if I need to test using th output of an event? 
    ...
    function testFulfillRandomWordsCanOnlyBeCalledAfterPerformanceUpkeep(
